...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = "pk.eyJ1IjoiYXJqdW5tdXJhbGkiLCJhIjoiY2t4emlxZjZ3MzBvbjJ1bXZzaGticXJ2cyJ9.Z2jXIfgs8Nqd4PyaxPyOGw";
  var map = new mapboxgl.Map({
    container: "map",
    // put an element with id map
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Marker({
      element: el,
      anchor: "bottom"
    }).setLngLat(loc.coordinates).addTo(map); //Extend map bounds to include the current location
    //add popup
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)('success', "Your account is successfully created");
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
var stripe = Stripe("pk_test_51KL7W5SAGfo0Dr9ET6Khmrba5PxIygVvrB94BB2xJCp0b9VY3JWDrOunRohvsuf8FVESXFMspj8XHmooqp6vA1dD00o4DMdpJY");
